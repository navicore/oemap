...
public class OldPresenceDbHelperTestCase extends AndroidTestCase {

    private OldPresenceDbHelper _dbHelper;

    @Override
    protected void setUp() {
        _dbHelper = new OldPresenceDbHelper(getContext(), "testPresenceDb");
    }
