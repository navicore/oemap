...
@Deprecated
public class OldPresenceDbHelper extends SQLiteOpenHelper {

    private static int DATABASE_VERSION = 3;
    SQLiteDatabase _db;

    public OldPresenceDbHelper(Context context, String dbname) { //for tests
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        OeLog.w("upgrading presence db from version " + oldVersion + " to " + newVersion + ". all data will be lost");
